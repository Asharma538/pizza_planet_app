...
class _MenuState extends State<Menu> {
  ...
  var Pizza = ["images/pizza_carousel.jpg","images/pizza_carousel.jpg","images/pizza_carousel.jpg"];
                              ...
                              Row(
                                children: [
                                  ...
                                  ElevatedButton(
                                    onPressed: () {
                                      Home.pizza = true;
                                      Provider.of<CartProvider>(context, listen: false).addItem(Home.pizzasName[j], Pizza_val[j]);
                                    },
                                  ...
                                  Row(
                                    children: [
                                      ...
                                      ElevatedButton(
                                        onPressed: () {
                                          Home.burger = true;
                                          Provider.of<CartProvider>(context, listen: false).addItem(Home.burgerName[j], Home.burgerCosts[j]);
                                        },
                                        style: ElevatedButton.styleFrom(
                                            backgroundColor: primaryBlue),
                                        child: const Text("+ADD"),
                                ...
                                children: [
                                  ...
                                  ElevatedButton(
                                    onPressed: () {
                                      ...
                                      Provider.of<CartProvider>(context, listen: false).addItem(Home.breadName[j], Home.breadCosts[j]);
                                    },
                                    style: ElevatedButton.styleFrom(
                                        backgroundColor: primaryBlue),
                                    child: const Text("+ADD"),
